...
def main():
    ...
    ap.add.argument("--p_max", type=float, default=0.03)
    ...
    ap.add.argument("--ma_quantile", type=float, default=0.60)
    ap.add.argument("--epsilon_override", type=float, default=None)
    ap.add_argument("--base_source", choices=["population","demand"], default="population")
    ap.add.argument("--demand_sheet", type=str, default="Market Analyzes")
    ap.add.argument("--k_owned", type=float, default=None)
    ap.add.argument("--pmax_owned_mult", type=float, default=1.0)
    ap.add.argument("--objective", choices=["profit","blended"], default="profit")
    ap.add.argument("--alpha_blend", type=float, default=0.7)
    ap.add.argument("--rho_default", type=float, default=0.6)
    ap.add.argument("--price_override", type=str, default=None)
    ap.add.argument("--min_mkt_owned_pc", type=float, default=0.0)
    ap.add.argument("--min_mkt_owned_total", type=float, default=0.0)
    ap.add.argument("--lock_price_owned", action="store_true")
    ap.add.argument("--target_share", type=str, default=None, help="Ex: 'United States:0.05,Canada:0.02' (fração 0-1 por país)")
    ap.add.argument("--share_penalty", type=float, default=0.0, help="Peso da penalidade (em unidades ~Receita)")
    ap.add.argument("--list_sheets", action="store_true")
    ap.add.argument("--debug", action="store_true")
    args = ap.parse_args()
